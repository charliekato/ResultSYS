...
namespace ResultSys
{
    ...
    public partial class Form2 : Form
    {
        ...
        private void layout_label()
        {
            ...
            int topMargin = this.Height / 10;  // 88
            ...
            int kanaHeight = 18*Width/1200; // laneHeight / 5;
            int raceNameHeight = 32*Width/1200; // laneHeight * 3 / 10;
            //      laneHeight = 100;
            int fontSize = 30*this.Width/1200; // was  30
            int fontSizeKana = 12*Width/1200;
            int fontSize4Rly = 18*Width/1200;
            int fontSizeShozoku = 22*Width/1200;
            int fontsize4relayTeam = 24*Width/1200;
            int fontsize4RaceName = 17 * Width / 1200;
